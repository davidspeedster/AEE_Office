                ...
                <div class="col-lg-6 col-md-12">
                    ...
                    <div class="about-img ">
                        <div class="about-font-img ">
                            <img src={{asset("/assets/AEE_Cool/img/gallery/group_pic.jpg")}} alt="">
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src={{asset("assets/AEE_Cool//img/gallery/team2.png")}} alt="">
                        </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src={{asset("assets/AEE_Cool//img/gallery/team3.png")}} alt="">
                        </div>
                        <div class="team-caption">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                    <div class="single-team mb-30">
                        <div class="team-img">
                            <img src={{asset("assets/AEE_Cool//img/gallery/team1.png")}} alt="">
                        </div>
                        <div class="team-caption">
