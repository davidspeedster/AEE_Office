...
<main>
    ...
    <div class="slider-area ">
        <div class="slider-active">
            <div class="single-slider  hero-overly slider-height d-flex align-items-center" data-background="/assets/AEE_Dark/img/hero/h1_hero.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-11">
                            <div class="hero__caption">
                                ...
                                <h1 data-animation="fadeInUp" data-delay=".5s">Afro-European</h1>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single-service-cap mb-30">
                        <div class="service-img">
                            <img src={{asset("/assets/AEE_Dark/img/service/servicess1.png")}} alt="">
                        </div>
                        ...
                        <div class="service-icon">
                            <img src={{asset("/assets/AEE_Dark/img/icon/services_icon1.png")}} alt="">
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single-service-cap mb-30">
                        <div class="service-img">
                            <img src={{asset("/assets/AEE_Dark/img/service/servicess2.png")}} alt="">
                        </div>
                        <div class="service-cap">
                            <h4><a href="services_details.html">Engineering techniques & implementation</a></h4>
                            <a href="services_details.html" class="more-btn">Read More <i class="ti-plus"></i></a>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single-service-cap mb-30">
                        <div class="service-img">
                            <img src={{asset("/assets/AEE_Dark/img/service/servicess3.png")}} alt="">
                        </div>
                        <div class="service-cap">
    ...
    <section class="support-company-area fix pt-10">
        <div class="support-wrapper align-items-end">
            ...
            <div class="right-content">
                <!-- img -->
                <div class="right-img">
                    <img src={{asset("/assets/AEE_Dark/img/gallery/safe_in.png")}} alt="">
                </div>
    ...
    <section class="contact-with-area" data-background="/assets/AEE_Dark/img/gallery/section-bg2.jpg">
        <div class="container">
            <div class="row">
    ...
    <div class="count-area">
        <div class="container">
            <div class="count-wrapper count-bg" data-background="/assets/AEE_Dark/img/gallery/section-bg3.jpg">
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6">
                    ...
                    <div class="single-news mb-30">
                        <div class="news-img">
                            <img src={{asset("/assets/AEE_Dark/img/david/david_1.png")}} alt="">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6">
                    ...
                    <div class="single-news mb-30">
                        <div class="news-img">
                            <img src={{asset("/assets/AEE_Dark/img/david/david_2.png")}} alt="">
                            <div class="news-date text-center">
                                <span>24</span>
                                <p>Now</p>
                            </div>
