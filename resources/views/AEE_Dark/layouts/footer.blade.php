                        ...
                        <div class="col-lg-4 col-md-4 col-sm-8">
                            <div class="single-footer-caption mb-30">
                                ...
                                <div class="footer-logo">
                                    <a href="index.html"><img src={{asset("assets/AEE_Dark/img/logo/logo2_footer.png")}} alt=""></a>
                                </div>
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-5">
                            <div class="single-footer-caption mb-50">
                                <div class="footer-tittle">
                                    <h4>Quick Links</h4>
                                    <ul>
                                        <li><a href="/AEE_Dark/about">About</a></li>
                                        <li><a href="/AEE_Dark/services">Services</a></li>
                                        <li><a href="/AEE_Dark/project_details">Projects</a></li>
                                        <li><a href="/AEE_Dark/contact">Contact Us</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-8">
                            <div class="single-footer-caption mb-50">
                                ...
                                <div class="map-footer">
                                    <img src={{asset("assets/AEE_Dark/img/gallery/map-footer.png")}} alt="">
                                </div>
                            </div>
                        </div>
                    </div>
