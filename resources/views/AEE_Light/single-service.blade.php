                                    ...
                                    <div class="ht-portfolio-pic-show">
                                        <div class="ht-portfolio-full-image tab-content">
                                            <div role="tabpanel" class="tab-pane fade in active" id="img-tab-1">
                                                <img src={{asset("/assets/AEE_Light/images/blog/big-images/4.jpg")}} alt="full-image">
                                            </div>
                                            <div role="tabpanel" class="tab-pane fade" id="img-tab-2">
                                                <img src={{asset("/assets/AEE_Light/images/blog/big-images/3.jpg")}} alt="full-image">
                                            </div>
                                            <div role="tabpanel" class="tab-pane fade" id="img-tab-3">
                                                <img src={{asset("/assets/AEE_Light/images/blog/big-images/2.jpg")}} alt="full-image">
                                            </div>
                                            <div role="tabpanel" class="tab-pane fade" id="img-tab-4">
                                                <img src={{asset("/assets/AEE_Light/images/blog/big-images/1.jpg")}} alt="full-image">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Start Small images -->
