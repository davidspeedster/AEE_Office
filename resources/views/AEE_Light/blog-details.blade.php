                            ...
                            <div class="blog__inner">
                                <div class="blog__thumb">
                                    <a href="blog-details.html">
                                        <img src={{asset("/assets/AEE_Light/images/blog/big-images/4.jpg")}} alt="blog image">
                                    </a>
                                ...
                                <div class="htc__comment__inner">
                                    ...
                                    <div class="single__comment">
                                        <div class="bl__comment__thumb">
                                            <img src={{asset("/assets/AEE_Light/images/comment/1.jpg")}} alt="comment images">
                                        </div>
                                    ...
                                    <div class="single__comment reply">
                                        <div class="bl__comment__thumb">
                                            <img src={{asset("/assets/AEE_Light/images/comment/2.jpg")}} alt="comment images">
                                        </div>
                                        <div class="bl__comment__details">
                                            <div class="bl__comment__meta">
                                                <h2><a href="#">By Kalvin</a></h2>
                                    ...
                                    <div class="single__comment">
                                        <div class="bl__comment__thumb">
                                            <img src={{asset("/assets/AEE_Light/images/comment/3.jpg")}} alt="comment images">
                                        </div>
                                        <div class="bl__comment__details">
                                            <div class="bl__comment__meta">
                                                <h2><a href="#">By Kalvin</a></h2>
