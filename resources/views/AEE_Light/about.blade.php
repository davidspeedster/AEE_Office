...
@section('content')
    ...
    <div class="wrapper">
        ...
        <section class="htc__mission__area bg__gray">
            ...
            <div class="htc__offer__thumb">
                <div class="htc__offer__thumb__inner">
                    <img src={{asset("assets/AEE_Light/images/about/1.jpg")}} alt="offer img">
                </div>
            </div>
        </section>
        <!-- End Offer Area -->
        ...
        <section class="htc__testimonial__area ptb--130" data--gray__overlay="9" style="background: rgba(0, 0, 0, 0) url(/assets/AEE_Light/images/bg/1.jpg) no-repeat fixed center center / cover ;">
            <div class="container">
                <div class="row">
        ...
        <section class="htc__counterup__area ptb--50" style="background: rgba(0, 0, 0, 0) url(/assets/AEE_Light/images/bg/3.jpg) no-repeat scroll center center / cover ;">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
