         ...
         <div class="row mt30">
			<div class="col-md-4 col-sm-4 col-xs-9">
				<div class="team-wrapper">
					<img src={{asset("assets/AEE_Black/images/team1.jpg")}} class="img-responsive" alt="team img">
					<h3>LINDA</h3>
			...
			<div class="col-md-4 col-sm-4 col-xs-9">
				<div class="team-wrapper">
					<img src={{asset("assets/AEE_Black/images/team2.jpg")}} class="img-responsive" alt="team img">
					<h3>JULIA</h3>
					<h4>UX Designer</h4>
					<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismo.</p>
				</div>
			...
			<div class="col-md-4 col-sm-4 col-xs-9">
				<div class="team-wrapper">
					<img src={{asset("assets/AEE_Black/images/team3.jpg")}} class="img-responsive" alt="team img">
					<h3>MARY</h3>
