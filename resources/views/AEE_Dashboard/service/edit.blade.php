...
<div class="dashboard-wrapper">
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="section-block" id="basicform">
            <h3 class="section-title">Edit this service</h3>
        </div>
        <div class="card">
                ...
                <form action="/AEE_Dashboard/service/{{$service->id}}" method="POST">
                    ...
                    @method('PATCH')
                     <div class="form-group">
                        ...
                        <input id="text" name="text" type="text" class="form-control" value="{{old('text')??$service->text}}">
                        <div class="text-danger">{{$errors->first('text')}}</div>
                    </div>

                    <div class="form-group">
                        <label for="details" class="col-form-label">Service Details:</label>
                        <textarea class="form-control" name="details" id="details" rows="3">{{old('details')??$service->details}}</textarea>
